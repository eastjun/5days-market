				...
				<div class="col-lg-9">
					...
					<form method="post">
						    <div class="container mt-5">
						        ...
						        <a href="/boards" class="btn btn-primary mt-3">목록</a>
						    </div>
								<%if (userid !=null&& uniqueid != null && uniqueid==100001){ %>
										<div class="mt-3 d-flex justify-content-end">
									     <a href="/boards/${boardSelect.num}/edit" class="btn btn-primary me-2">수정하기</a>
			...
			<script>
					document.getElementById('boardDelete').addEventListener(
							...
							function(event) {
								...
								if (result) {
									window.location.href = "/boards/${boardSelect.num}/delete";
								} else {
