	...
	<header class="bg-dark py-5"
		...
		<div class="container px-4 px-lg-5 my-5">
			<div class="text-center text-black">
				<h1 class="display-4 fw-bolder">상품 등록하기</h1>
			</div>
		</div>
	</header>
			...
			<hr class="mb-5">
				...
				<div class="row">
					  <div class="col-md-6 mb-3">
					    ...
					    <input type="text" class="form-control" id="price" name="price" placeholder="숫자만 입력하세요" required>
					  </div>
					  <div class="col-md-6 mb-3">
					    <label for="origin" class="form-label">원산지</label>
					    <input type="text" class="form-control" id="origin" name="origin" placeholder="원산지를 입력해주세요" required>
					  </div>
				</div>
				<div class="row">
			        <div class="col-md-6 mb-3">
			          ...
			          <div class="col-md-6 mb-3" id="shipFee" style="display: none;">
					    ...
					    <input type="text" class="form-control" id="shipprice" name="shipprice" placeholder="숫자만 입력" value="0">
					  </div>
      			</div>
